...
# Key-Value Store API
@key_value_bp.route('/key-value', methods=['GET'])
@login_required
...
@key_value_bp.route('/key-value/<string:key>', methods=['GET'])
@login_required
...
@key_value_bp.route('/key-value/<string:key>', methods=['PUT'])
@login_required
...
@key_value_bp.route('/key-value', methods=['POST'])
@login_required
...
@key_value_bp.route('/key-value/<string:key>', methods=['DELETE'])
@login_required
...
@key_value_bp.route('/key-value/bulk', methods=['POST'])
@login_required
